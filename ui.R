...
ui <- bootstrapPage(
             ...
             navbarPage(windowTitle ="Ghana",
                        title = div(img(src = "https://akilimo.sirv.com/images/gh.png","Ghana", height = "60", style="margin-top: -14px;
                                padding-right:10px;
                               padding-bottom:10px")),
             ...
             tabPanel("Expected yield for different planting and harvest schedules",id = "spt",
                      ...
                      sidebarLayout(
                        sidebarPanel(width = 3,
                                     ...
                                     pickerInput("reg_ghanaSP", "Select region",
                        ...
                        conditionalPanel(condition="input.unit_locSP == 'acre'| input.unit_locSP == 'hectare'",
                                         absolutePanel(id = "sp2", class = "card", bottom = 220, left = 100, width = 70, fixed=TRUE, draggable = TRUE, 
                        ...
                        conditionalPanel(condition = ("input.btn_SP > 0"),
                                         absolutePanel(id = "sp3", class = "card", bottom = 150, left = 85, width = 70, fixed=TRUE, draggable = TRUE, 
                                         ...
                                         absolutePanel(id = "logo2", class = "card", bottom = 20, left = 10, width = 70, fixed=TRUE, draggable = TRUE, 
                                                       
                                                       br(),
                                                       br(),
                                                       br(),
                                                       br(),
                                                       tags$img(src='pics/akilimo4.jpg',height = 100, width = 150
                                                       )
                                         )
